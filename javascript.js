...
/*
var href = 'https://www.google.com/search?q=' + (newCuisine.earVersion.substring(0, newCuisine.earVersion.indexOf('-')));

$("#cuisineDisplay").html(('<a href="'+href+'">'+href+'</a>'));
*/

/*
var href = "https://www.google.co.in";
var tag = '<a href="'+href+'" target = "_blank">'+href+'</a><br/>';
$("#cuisineDisplay").html(tag);
$("#cuisineDisplay").append(tag);
*/
...
/*
        if (document.getElementById('純粹諗食乜類型').checked) { 

    var randomNumber = Math.floor(Math.random()*(CuisineType.length));
    document.getElementById('cuisineDisplay').innerHTML=CuisineType[randomNumber];
}
*/

if(document.getElementById('元朗').checked){

 var randomNumber = Math.floor(Math.random()*(YuenLong.length));
    document.getElementById('cuisineDisplay').innerHTML=YuenLong[randomNumber];
}

else if(document.getElementById('天水圍').checked){

 var randomNumber = Math.floor(Math.random()*(TinShuiWai.length));
    document.getElementById('cuisineDisplay').innerHTML=TinShuiWai[randomNumber];
}

else if(document.getElementById('上水').checked){

 var randomNumber = Math.floor(Math.random()*(SheungShui.length));
    document.getElementById('cuisineDisplay').innerHTML=SheungShui[randomNumber];
}

else if(document.getElementById('粉嶺').checked){

 var randomNumber = Math.floor(Math.random()*(Fanling.length));
    document.getElementById('cuisineDisplay').innerHTML=Fanling[randomNumber];
}

else if(document.getElementById('大埔區').checked){

 var randomNumber = Math.floor(Math.random()*(Taipo.length));
    document.getElementById('cuisineDisplay').innerHTML=Taipo[randomNumber];
}

else if(document.getElementById('屯門').checked){

 var randomNumber = Math.floor(Math.random()*(TuenMun.length));
    document.getElementById('cuisineDisplay').innerHTML=TuenMun[randomNumber];
}

else if(document.getElementById('大圍').checked){

 var randomNumber = Math.floor(Math.random()*(TaiWai.length));
    document.getElementById('cuisineDisplay').innerHTML=TaiWai[randomNumber];
}

else if(document.getElementById('沙田').checked){

 var randomNumber = Math.floor(Math.random()*(ShaTin.length));
    document.getElementById('cuisineDisplay').innerHTML=ShaTin[randomNumber];
}

else if(document.getElementById('火炭').checked){

 var randomNumber = Math.floor(Math.random()*(Fotan.length));
    document.getElementById('cuisineDisplay').innerHTML=Fotan[randomNumber];
}

else if(document.getElementById('石門').checked){

 var randomNumber = Math.floor(Math.random()*(ShekMun.length));
    document.getElementById('cuisineDisplay').innerHTML=ShekMun[randomNumber];
}

else if(document.getElementById('馬鞍山').checked){

 var randomNumber = Math.floor(Math.random()*(MaOnShan.length));
    document.getElementById('cuisineDisplay').innerHTML=MaOnShan[randomNumber];
}

else if(document.getElementById('荃灣區').checked){

 var randomNumber = Math.floor(Math.random()*(TsuenWan.length));
    document.getElementById('cuisineDisplay').innerHTML=TsuenWan[randomNumber];
}

else if(document.getElementById('葵涌').checked){

 var randomNumber = Math.floor(Math.random()*(KwaiChung.length));
    document.getElementById('cuisineDisplay').innerHTML=KwaiChung[randomNumber];
}

else if(document.getElementById('葵芳').checked){

 var randomNumber = Math.floor(Math.random()*(KwaiFong.length));
    document.getElementById('cuisineDisplay').innerHTML=KwaiFong[randomNumber];
}

else if(document.getElementById('將軍澳').checked){

 var randomNumber = Math.floor(Math.random()*(TseungKwanO.length));
    document.getElementById('cuisineDisplay').innerHTML=TseungKwanO[randomNumber];
}

else if(document.getElementById('西貢').checked){

 var randomNumber = Math.floor(Math.random()*(SaiKung.length));
    document.getElementById('cuisineDisplay').innerHTML=SaiKung[randomNumber];
}

else if(document.getElementById('離島區').checked){

 var randomNumber = Math.floor(Math.random()*(Island.length));
    document.getElementById('cuisineDisplay').innerHTML=Island[randomNumber];
}

else if(document.getElementById('九龍城').checked){

 var randomNumber = Math.floor(Math.random()*(KowloonCity.length));
    document.getElementById('cuisineDisplay').innerHTML=KowloonCity[randomNumber];
}

else if(document.getElementById('九龍塘').checked){

 var randomNumber = Math.floor(Math.random()*(KowloonTong.length));
    document.getElementById('cuisineDisplay').innerHTML=KowloonTong[randomNumber];
}

else if(document.getElementById('土瓜灣').checked){

 var randomNumber = Math.floor(Math.random()*(ToKwaWan.length));
    document.getElementById('cuisineDisplay').innerHTML=ToKwaWan[randomNumber];
}

else if(document.getElementById('紅磡').checked){

 var randomNumber = Math.floor(Math.random()*(HungHom.length));
    document.getElementById('cuisineDisplay').innerHTML=HungHom[randomNumber];
}

else if(document.getElementById('佐敦').checked){

 var randomNumber = Math.floor(Math.random()*(Jordan.length));
    document.getElementById('cuisineDisplay').innerHTML=Jordan[randomNumber];
}

else if(document.getElementById('大角咀').checked){

 var randomNumber = Math.floor(Math.random()*(TaiKokTsui.length));
    document.getElementById('cuisineDisplay').innerHTML=TaiKokTsui[randomNumber];
}

else if(document.getElementById('太子').checked){

 var randomNumber = Math.floor(Math.random()*(PrinceEdward.length));
    document.getElementById('cuisineDisplay').innerHTML=PrinceEdward[randomNumber];
}

else if(document.getElementById('尖沙咀').checked){

 var randomNumber = Math.floor(Math.random()*(TsimShaTsui.length));
    document.getElementById('cuisineDisplay').innerHTML=TsimShaTsui[randomNumber];
}

else if(document.getElementById('旺角').checked){

 var randomNumber = Math.floor(Math.random()*(MongKok.length));
    document.getElementById('cuisineDisplay').innerHTML=MongKok[randomNumber];
}

else if(document.getElementById('油麻地').checked){

 var randomNumber = Math.floor(Math.random()*(YauMaTei.length));
    document.getElementById('cuisineDisplay').innerHTML=YauMaTei[randomNumber];
}

else if(document.getElementById('深水埗').checked){

 var randomNumber = Math.floor(Math.random()*(ShamShuiPo.length));
    document.getElementById('cuisineDisplay').innerHTML=ShamShuiPo[randomNumber];
}

else if(document.getElementById('石硤尾').checked){

 var randomNumber = Math.floor(Math.random()*(ShekKipMei.length));
    document.getElementById('cuisineDisplay').innerHTML=ShekKipMei[randomNumber];
}

else if(document.getElementById('美孚').checked){

 var randomNumber = Math.floor(Math.random()*(MeiFoo.length));
    document.getElementById('cuisineDisplay').innerHTML=MeiFoo[randomNumber];
}

else if(document.getElementById('長沙灣').checked){

 var randomNumber = Math.floor(Math.random()*(CheungShaWan.length));
    document.getElementById('cuisineDisplay').innerHTML=CheungShaWan[randomNumber];
}

else if(document.getElementById('觀塘').checked){

 var randomNumber = Math.floor(Math.random()*(KwunTong.length));
    document.getElementById('cuisineDisplay').innerHTML=KwunTong[randomNumber];
}

else if(document.getElementById('九龍灣').checked){

 var randomNumber = Math.floor(Math.random()*(KowloonBay.length));
    document.getElementById('cuisineDisplay').innerHTML=KowloonBay[randomNumber];
}

else if(document.getElementById('藍田/油塘/秀茂坪').checked){

 var randomNumber = Math.floor(Math.random()*(LamTin.length));
    document.getElementById('cuisineDisplay').innerHTML=LamTin[randomNumber];
}

else if(document.getElementById('牛頭角').checked){

 var randomNumber = Math.floor(Math.random()*(NgauTauKok.length));
    document.getElementById('cuisineDisplay').innerHTML=NgauTauKok[randomNumber];
}

else if(document.getElementById('鑽石山').checked){

 var randomNumber = Math.floor(Math.random()*(DiamondHill.length));
    document.getElementById('cuisineDisplay').innerHTML=DiamondHill[randomNumber];
}

else if(document.getElementById('新蒲崗').checked){

 var randomNumber = Math.floor(Math.random()*(SanPoKong.length));
    document.getElementById('cuisineDisplay').innerHTML=SanPoKong[randomNumber];
}

else if(document.getElementById('上環').checked){

 var randomNumber = Math.floor(Math.random()*(SheungWan.length));
    document.getElementById('cuisineDisplay').innerHTML=SheungWan[randomNumber];
}

else if(document.getElementById('中環').checked){

 var randomNumber = Math.floor(Math.random()*(Central.length));
    document.getElementById('cuisineDisplay').innerHTML=Central[randomNumber];
}
else if(document.getElementById('堅尼地城').checked){

 var randomNumber = Math.floor(Math.random()*(KennedyTown.length));
    document.getElementById('cuisineDisplay').innerHTML=KennedyTown[randomNumber];

}

else if(document.getElementById('西環').checked){

 var randomNumber = Math.floor(Math.random()*(SaiWan.length));
    document.getElementById('cuisineDisplay').innerHTML=SaiWan[randomNumber];
}

else if(document.getElementById('薄扶林').checked){

 var randomNumber = Math.floor(Math.random()*(PokFuLam.length));
    document.getElementById('cuisineDisplay').innerHTML=PokFuLam[randomNumber];
}

else if(document.getElementById('北角').checked){

 var randomNumber = Math.floor(Math.random()*(NorthPoint.length));
    document.getElementById('cuisineDisplay').innerHTML=NorthPoint[randomNumber];
}

else if(document.getElementById('天后').checked){

 var randomNumber = Math.floor(Math.random()*(Tinhau.length));
    document.getElementById('cuisineDisplay').innerHTML=Tinhau[randomNumber];

}else if(document.getElementById('太古').checked){

 var randomNumber = Math.floor(Math.random()*(TaiKoo.length));
    document.getElementById('cuisineDisplay').innerHTML=TaiKoo[randomNumber];

}else if(document.getElementById('柴灣').checked){

 var randomNumber = Math.floor(Math.random()*(ChaiWan.length));
    document.getElementById('cuisineDisplay').innerHTML=ChaiWan[randomNumber];

}else if(document.getElementById('炮台山').checked){

 var randomNumber = Math.floor(Math.random()*(FortressHill.length));
    document.getElementById('cuisineDisplay').innerHTML=FortressHill[randomNumber];

}else if(document.getElementById('筲箕灣').checked){

 var randomNumber = Math.floor(Math.random()*(QuarryBay.length));
    document.getElementById('cuisineDisplay').innerHTML=QuarryBay[randomNumber];

}else if(document.getElementById('西灣河').checked){

 var randomNumber = Math.floor(Math.random()*(SaiWanHo.length));
    document.getElementById('cuisineDisplay').innerHTML=SaiWanHo[randomNumber];

}else if(document.getElementById('鰂魚涌').checked){

 var randomNumber = Math.floor(Math.random()*(QuarryBay.length));
    document.getElementById('cuisineDisplay').innerHTML=QuarryBay[randomNumber];

}else if(document.getElementById('大坑').checked){

 var randomNumber = Math.floor(Math.random()*(TaiHang.length));
    document.getElementById('cuisineDisplay').innerHTML=TaiHang[randomNumber];

}else if(document.getElementById('灣仔').checked){

 var randomNumber = Math.floor(Math.random()*(WanChai.length));
    document.getElementById('cuisineDisplay').innerHTML=WanChai[randomNumber];
}

else if(document.getElementById('跑馬地').checked){

 var randomNumber = Math.floor(Math.random()*(CausewayBay.length));
    document.getElementById('cuisineDisplay').innerHTML=CausewayBay[randomNumber];
}
